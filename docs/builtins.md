...
**328 built-in functions** across 21 categories.
...
| Function | Description |
|----------|-------------|
| `fn! array_clone(array: [T]) -> [T]` | Allocate a shallow clone, preserving fixed or dynamic shape |
| `fn! array_repeat(value: T, count: i32) -> [T]` | Allocate a dynamic array with count shallow copies |
| `fn! array_reverse(array: [T])` | Reverse a mutable fixed or dynamic array in place |
| `fn! array_fill(array: [T], value: T)` | Fill a mutable fixed or dynamic array in place |
| `fn! array_swap(array: [T], left: i32, right: i32)` | Swap two checked indices in a mutable array |
| `fn! array_clear(array: [T])` | Clear a mutable dynamic array |
| `fn! array_extend(destination: [T], source: [T])` | Append an array to a mutable dynamic destination |
| `fn! array_insert(array: [T], index: i32, value: T)` | Insert a value at a checked index in a mutable dynamic array |
| `fn! array_remove_at(array: [T], index: i32) -> T` | Remove and return a value from a mutable dynamic array |
| `fn! array_slice(array: [T], start: i32, end: i32) -> [T]` | Allocate a dynamic half-open slice [start, end) |
| `fn array_contains_bool(array: [bool], value: bool) -> bool` | Test whether a bool array contains a value |
| `fn array_contains_i32(array: [i32], value: i32) -> bool` | Test whether a i32 array contains a value |
| `fn array_contains_i64(array: [i64], value: i64) -> bool` | Test whether a i64 array contains a value |
| `fn array_contains_f64(array: [f64], value: f64) -> bool` | Test whether a f64 array contains a value |
| `fn array_contains_str(array: [str], value: str) -> bool` | Test whether a str array contains a value |
| `fn array_index_of_bool(array: [bool], value: bool) -> i32` | Find the first matching bool value, or -1 |
| `fn array_index_of_i32(array: [i32], value: i32) -> i32` | Find the first matching i32 value, or -1 |
| `fn array_index_of_i64(array: [i64], value: i64) -> i32` | Find the first matching i64 value, or -1 |
| `fn array_index_of_f64(array: [f64], value: f64) -> i32` | Find the first matching f64 value, or -1 |
| `fn array_index_of_str(array: [str], value: str) -> i32` | Find the first matching str value, or -1 |
| `fn array_last_index_of_bool(array: [bool], value: bool) -> i32` | Find the last matching bool value, or -1 |
| `fn array_last_index_of_i32(array: [i32], value: i32) -> i32` | Find the last matching i32 value, or -1 |
| `fn array_last_index_of_i64(array: [i64], value: i64) -> i32` | Find the last matching i64 value, or -1 |
| `fn array_last_index_of_f64(array: [f64], value: f64) -> i32` | Find the last matching f64 value, or -1 |
| `fn array_last_index_of_str(array: [str], value: str) -> i32` | Find the last matching str value, or -1 |
| `fn array_count_bool(array: [bool], value: bool) -> i32` | Count matching bool values |
| `fn array_count_i32(array: [i32], value: i32) -> i32` | Count matching i32 values |
| `fn array_count_i64(array: [i64], value: i64) -> i32` | Count matching i64 values |
| `fn array_count_f64(array: [f64], value: f64) -> i32` | Count matching f64 values |
| `fn array_count_str(array: [str], value: str) -> i32` | Count matching str values |
| `fn array_compare_bool(left: [bool], right: [bool]) -> i32` | Lexicographically compare two bool arrays |
| `fn array_compare_i32(left: [i32], right: [i32]) -> i32` | Lexicographically compare two i32 arrays |
| `fn array_compare_i64(left: [i64], right: [i64]) -> i32` | Lexicographically compare two i64 arrays |
| `fn array_compare_f64(left: [f64], right: [f64]) -> i32` | Lexicographically compare two f64 arrays |
| `fn array_compare_str(left: [str], right: [str]) -> i32` | Lexicographically compare two str arrays |
| `fn! array_sort_bool(array: [bool])` | Sort a mutable bool array in place |
| `fn! array_sort_i32(array: [i32])` | Sort a mutable i32 array in place |
| `fn! array_sort_i64(array: [i64])` | Sort a mutable i64 array in place |
| `fn! array_sort_f64(array: [f64])` | Sort a mutable f64 array in place |
| `fn! array_sort_str(array: [str])` | Sort a mutable str array in place |
| `fn array_any_bool(array: [bool], predicate: fn(bool) -> bool) -> bool` | Test whether any bool element matches a pure predicate |
| `fn array_any_i32(array: [i32], predicate: fn(i32) -> bool) -> bool` | Test whether any i32 element matches a pure predicate |
| `fn array_any_i64(array: [i64], predicate: fn(i64) -> bool) -> bool` | Test whether any i64 element matches a pure predicate |
| `fn array_any_f64(array: [f64], predicate: fn(f64) -> bool) -> bool` | Test whether any f64 element matches a pure predicate |
| `fn array_any_str(array: [str], predicate: fn(str) -> bool) -> bool` | Test whether any str element matches a pure predicate |
| `fn array_all_bool(array: [bool], predicate: fn(bool) -> bool) -> bool` | Test whether all bool elements match a pure predicate |
| `fn array_all_i32(array: [i32], predicate: fn(i32) -> bool) -> bool` | Test whether all i32 elements match a pure predicate |
| `fn array_all_i64(array: [i64], predicate: fn(i64) -> bool) -> bool` | Test whether all i64 elements match a pure predicate |
| `fn array_all_f64(array: [f64], predicate: fn(f64) -> bool) -> bool` | Test whether all f64 elements match a pure predicate |
| `fn array_all_str(array: [str], predicate: fn(str) -> bool) -> bool` | Test whether all str elements match a pure predicate |
| `fn! array_filter_bool(array: [bool], predicate: fn(bool) -> bool) -> [bool]` | Allocate an ordered array of matching bool elements |
| `fn! array_filter_i32(array: [i32], predicate: fn(i32) -> bool) -> [i32]` | Allocate an ordered array of matching i32 elements |
| `fn! array_filter_i64(array: [i64], predicate: fn(i64) -> bool) -> [i64]` | Allocate an ordered array of matching i64 elements |
| `fn! array_filter_f64(array: [f64], predicate: fn(f64) -> bool) -> [f64]` | Allocate an ordered array of matching f64 elements |
| `fn! array_filter_str(array: [str], predicate: fn(str) -> bool) -> [str]` | Allocate an ordered array of matching str elements |
| `fn array_fold_bool(array: [bool], initial: bool, step: fn(bool, bool) -> bool) -> bool` | Left-fold a bool array with a pure step function |
| `fn array_fold_i32(array: [i32], initial: i32, step: fn(i32, i32) -> i32) -> i32` | Left-fold a i32 array with a pure step function |
| `fn array_fold_i64(array: [i64], initial: i64, step: fn(i64, i64) -> i64) -> i64` | Left-fold a i64 array with a pure step function |
| `fn array_fold_f64(array: [f64], initial: f64, step: fn(f64, f64) -> f64) -> f64` | Left-fold a f64 array with a pure step function |
| `fn array_fold_str(array: [str], initial: str, step: fn(str, str) -> str) -> str` | Left-fold a str array with a pure step function |
| `fn! array_for_each_bool(array: [bool], visit: fn!(bool) -> unit)` | Visit each bool element in order |
| `fn! array_for_each_i32(array: [i32], visit: fn!(i32) -> unit)` | Visit each i32 element in order |
| `fn! array_for_each_i64(array: [i64], visit: fn!(i64) -> unit)` | Visit each i64 element in order |
| `fn! array_for_each_f64(array: [f64], visit: fn!(f64) -> unit)` | Visit each f64 element in order |
| `fn! array_for_each_str(array: [str], visit: fn!(str) -> unit)` | Visit each str element in order |
| `fn! array_map_bool_to_bool(array: [bool], transform: fn(bool) -> bool) -> [bool]` | Transform an ordered bool array into a bool array |
| `fn! array_map_bool_to_i32(array: [bool], transform: fn(bool) -> i32) -> [i32]` | Transform an ordered bool array into a i32 array |
| `fn! array_map_bool_to_i64(array: [bool], transform: fn(bool) -> i64) -> [i64]` | Transform an ordered bool array into a i64 array |
| `fn! array_map_bool_to_f64(array: [bool], transform: fn(bool) -> f64) -> [f64]` | Transform an ordered bool array into a f64 array |
| `fn! array_map_bool_to_str(array: [bool], transform: fn(bool) -> str) -> [str]` | Transform an ordered bool array into a str array |
| `fn! array_map_i32_to_bool(array: [i32], transform: fn(i32) -> bool) -> [bool]` | Transform an ordered i32 array into a bool array |
| `fn! array_map_i32_to_i32(array: [i32], transform: fn(i32) -> i32) -> [i32]` | Transform an ordered i32 array into a i32 array |
| `fn! array_map_i32_to_i64(array: [i32], transform: fn(i32) -> i64) -> [i64]` | Transform an ordered i32 array into a i64 array |
| `fn! array_map_i32_to_f64(array: [i32], transform: fn(i32) -> f64) -> [f64]` | Transform an ordered i32 array into a f64 array |
| `fn! array_map_i32_to_str(array: [i32], transform: fn(i32) -> str) -> [str]` | Transform an ordered i32 array into a str array |
| `fn! array_map_i64_to_bool(array: [i64], transform: fn(i64) -> bool) -> [bool]` | Transform an ordered i64 array into a bool array |
| `fn! array_map_i64_to_i32(array: [i64], transform: fn(i64) -> i32) -> [i32]` | Transform an ordered i64 array into a i32 array |
| `fn! array_map_i64_to_i64(array: [i64], transform: fn(i64) -> i64) -> [i64]` | Transform an ordered i64 array into a i64 array |
| `fn! array_map_i64_to_f64(array: [i64], transform: fn(i64) -> f64) -> [f64]` | Transform an ordered i64 array into a f64 array |
| `fn! array_map_i64_to_str(array: [i64], transform: fn(i64) -> str) -> [str]` | Transform an ordered i64 array into a str array |
| `fn! array_map_f64_to_bool(array: [f64], transform: fn(f64) -> bool) -> [bool]` | Transform an ordered f64 array into a bool array |
| `fn! array_map_f64_to_i32(array: [f64], transform: fn(f64) -> i32) -> [i32]` | Transform an ordered f64 array into a i32 array |
| `fn! array_map_f64_to_i64(array: [f64], transform: fn(f64) -> i64) -> [i64]` | Transform an ordered f64 array into a i64 array |
| `fn! array_map_f64_to_f64(array: [f64], transform: fn(f64) -> f64) -> [f64]` | Transform an ordered f64 array into a f64 array |
| `fn! array_map_f64_to_str(array: [f64], transform: fn(f64) -> str) -> [str]` | Transform an ordered f64 array into a str array |
| `fn! array_map_str_to_bool(array: [str], transform: fn(str) -> bool) -> [bool]` | Transform an ordered str array into a bool array |
| `fn! array_map_str_to_i32(array: [str], transform: fn(str) -> i32) -> [i32]` | Transform an ordered str array into a i32 array |
| `fn! array_map_str_to_i64(array: [str], transform: fn(str) -> i64) -> [i64]` | Transform an ordered str array into a i64 array |
| `fn! array_map_str_to_f64(array: [str], transform: fn(str) -> f64) -> [f64]` | Transform an ordered str array into a f64 array |
| `fn! array_map_str_to_str(array: [str], transform: fn(str) -> str) -> [str]` | Transform an ordered str array into a str array |
